...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Administrar subscripcion</h1>
      ...
      <div class="my-4 w-100" id="myChart" width="900" height="380">
       ...
       <div class="row">
        <a href="{{ url('/agregarsubscripcion') }}" class="btn btn-outline-success col-2">
    ...
    <td>
              <div class="btn-group">
                <a href="{{url('editarsubscripcion/'.$s->id.'/edit')}}" class="btn btn-outline-success">
                  Editar</a>
                  <form method="post" action="{{ url('/borrarsubscripcion/'.$s->id) }}">
    {{csrf_field()}}
    {{method_field('DELETE')}}
  ...
  @endforeach
  {{$subscriptions->links()}}<!--navegadores-->
    </tbody>
    </table>
      </div>
    </main>
