...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <input name="birth" type="date" class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      ...
      <input name="cursodeinteres" type="text" class="form-control" id="" aria-describedby="" required>
      </div>
