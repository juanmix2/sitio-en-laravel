...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="{{url('/guardarcurso')}}" method="post">
      {{csrf_field()}}
      <div class="mb-3">
      ...
      <input name="descripcion" type="text" class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      ...
      <input name="precio" type="number" class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      <label for="clave" class="form-label">Clave instructor</label>
      <input name="instructorfk" type="id" class="form-control" id="" aria-describedby="" required>
      </div>
