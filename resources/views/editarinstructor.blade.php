  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Actualizar instructor</h1>
      ...
      <form action="{{url('/editarinstructor/'.$instructor->id)}}" method="post">
      {{csrf_field()}}
      {{method_field('PATCH')}}
      
      <div class="mb-3">
      <label for="nombreyapellido" class="form-label">Nombre y apellido</label>
      <input name="nombre" type="text"  value="{{$instructor->nombre}}" class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      <label for="Nro de cedula" class="form-label">Cédula de identidad</label>
      <input name="cedula" type="text"value="{{$instructor->cedula}}"class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      <label for="fecha nac" class="form-label">teléfono</label>
      <input name="telefono" type="text" value="{{$instructor->telefono}}"class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      <label for="telefono" class="form-label">Dirección (opcional)</label>
      <input name="direccion" type="text"value="{{$instructor->direccion}}" class="form-control" id="" aria-describedby="" required>
      </div>
      <div class="mb-3">
      <label for="Direccion" class="form-label">Credenciales</label>
      <input name="credenciales" type="text"value="{{$instructor->credenciales}}" class="form-control" id="" aria-describedby="" required>
      </div>
